              ...
              <table-column label="健康状况">
                <template slot-scope="row">
                  <div class="user-health-status">
                    <span v-if="row.health_status == 'risk'">高风险</span>
                    <span v-if="row.health_status == 'mid_risk'">中风险</span>
                    <span v-if="row.health_status == 'low_risk'">低风险</span>
                    <span v-if="row.health_status == 'unkown'">未知</span>
                  </div>
                </template>
              </table-column>
              <table-column :sortable="false" :filterable="false" label="">
                <template slot-scope="row">
                  <div class="table__actions" :class="actionClass">
