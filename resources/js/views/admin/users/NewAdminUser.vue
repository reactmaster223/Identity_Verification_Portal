              ...
              <b-form @submit.stop.prevent="addNewMember">
                ...
                <div class="user-gender-role-edit">
                  ...
                  >
                    <b-form-select
                      ...
                      data-vv-as="角色"
                      :options="roles"
                      @change="onUpdate('role', addMemberData.role)"
                    ></b-form-select>
                ...
                <div class="company-region-edit">
                  <b-form-group
                    ...
                    v-if="addMemberData.role == 'company_admin'"
                  >
                    <b-form-select
                      id="company-input"
                      name="company-input"
                  ...
                  <b-form-group
                    ...
                    v-if="
                      addMemberData.role == 'regional_admin' ||
                      addMemberData.role == 'company_admin'
                    "
                  >
                    <b-form-select
                      id="region-input"
...
export default {
  ...
  created() {
    ...
    if (this.user_role == "admin") {
      this.roles = [
        { value: "company_admin", text: "各养老服务单位" },
      ...
      this.roles = [{ value: "company_admin", text: "各养老服务单位" }];
    }
    var today = new Date();
    var date =
      today.getFullYear() +
  ...
  methods: {
    ...
    onUpdate(type, value) {
      if (type == "region") {
        ...
        if (value == "company_admin" && this.user_role == "regional_admin") {
          this.addMemberData.region = Ls.get("Region Name");
          this.getCompaniesWithRegionName(this.addMemberData.region);
        }
      }
    },
